...
- Refactored util.pure.BufferedByteStream. It is now a child of io.BytesIO.
- Removed util.pure.Excursion as it is no longer needed.
- Added utcnow and utcfromtimestamp to the util module in preperation for their removal from datetime.
- Brought back the remoting support that was cut in miniamf. Everything except Elixir is present. NOTE: <a href="https://github.com/StdCarrot/Py3AMF/commit/5a9963f2ee5622b638dcccb374fdc3c70fdc567d">this commit</a> was used as a reference to fix the twisted tests.
