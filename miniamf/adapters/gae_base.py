...
class StubCollection(object):
    ...
    def add(self, stub, alias, key):
        ...
        @param alias: The L{miniamf.ClassAlias} linked to this stub.
...
class BaseDatastoreClassAlias(miniamf.ClassAlias):
    ...
    def getEncodableAttributes(self, obj, codec=None):
        ...
        # HACK: Force _key to be in the right spot (most of the time)
        final_attrs = {self.KEY_ATTR: self.encode_key(obj)}
