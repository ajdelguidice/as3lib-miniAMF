...
class BlobInfoClassAlias(miniamf.ClassAlias):
    """
...
miniamf.register_alias_type(BlobInfoClassAlias, blobstore.BlobInfo)
miniamf.register_class(blobstore.BlobInfo, '.'.join([
    blobstore.__name__,
