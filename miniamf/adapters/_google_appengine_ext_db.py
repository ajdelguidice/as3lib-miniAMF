...
class DataStoreClassAlias(gae_base.BaseDatastoreClassAlias):
    ...
    def getDecodableAttributes(self, obj, attrs, codec=None):
        ...
        if self.properties:
            models.decode_model_properties(obj, self.properties, attrs)
...
@models.register_property_decoder(db.FloatProperty)
...
@models.register_property_decoder(db.IntegerProperty)
...
@models.register_property_decoder(db.ListProperty)
...
@models.register_property_decoder(db.DateProperty)
...
@models.register_property_decoder(db.TimeProperty)
...
miniamf.register_alias_type(DataStoreClassAlias, db.Model)
miniamf.add_type(db.Query, util.to_list)
miniamf.add_type(db.Key, encode_xdb_key)
miniamf.add_type(db.Model, encode_xdb_entity)

miniamf.add_post_decode_processor(transform_xdb_stubs)
