...
from miniamf.remoting import gateway, amf0, amf3
...
class AMF0RequestProcessor(amf0.RequestProcessor):
    ...
    L{amf0.RequestProcessor<miniamf.remoting.amf0.RequestProcessor>}
    """
...
class AMF3RequestProcessor(amf3.RequestProcessor):
    """
    A Twisted friendly implementation of
    L{amf3.RequestProcessor<miniamf.remoting.amf3.RequestProcessor>}
    """
