...
from miniamf import remoting, DecodeError
...
class WebAppGateway(webapp.RequestHandler, gateway.BaseGateway):
    ...
    def getResponse(self, request):
        ...
        :type request: :class:`Envelope<miniamf.remoting.Envelope>`
        :rtype: :class:`Envelope<miniamf.remoting.Envelope>`
    ...
    def get(self):
        ...
        self.response.out.write(
            ...
            "To access this MiniAMF gateway you must use POST requests "
