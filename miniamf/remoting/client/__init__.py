...
DEFAULT_USER_AGENT = 'MiniAMF/%s' % (miniamf.version,)
...
class RemotingService(object):
    ...
    @ivar amf_version: The AMF version to use. See
        L{ENCODING_TYPES<miniamf.ENCODING_TYPES>}.
    ...
    @type headers: L{HeaderCollection<miniamf.remoting.HeaderCollection>}
    ...
    def __init__(self, url, amf_version=miniamf.AMF0, **kwargs):
    ...
    def getAMFRequest(self, requests):
        """
        Builds an AMF request {LEnvelope<miniamf.remoting.Envelope>} from a
