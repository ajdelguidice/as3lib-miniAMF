...
import miniamf
from miniamf import flex, util, amf3, amf0
from miniamf.tests.util import EncoderMixIn
...
class ArrayCollectionTestCase(unittest.TestCase, EncoderMixIn):
    ...
    def test_encode_amf0(self):
        self.encoder = miniamf.get_encoder(miniamf.AMF0)
    ...
    def test_decode_proxy(self):
        ...
        self.assertEqual(x.__class__, miniamf.MixedArray)
...
class ObjectProxyTestCase(unittest.TestCase, EncoderMixIn):
    ...
    def test_encode(self):
        x = flex.ObjectProxy(miniamf.MixedArray(a='spam', b=5))
    ...
    def test_get_attrs(self):
        ...
        self.assertEqual(x._amf_object, miniamf.ASObject())
