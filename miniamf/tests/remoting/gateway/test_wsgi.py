...
from miniamf.remoting.gateway.wsgi import WSGIGateway
...
class WSGIServerTestCase(unittest.TestCase):
    ...
    def makeRequest(self, service, body, raw=False):
        ...
        e = remoting.Envelope(miniamf.AMF3)
    ...
    def test_expose_request(self):
        ...
        def echo(http_request, data):
            self.assertTrue('miniamf.request' in http_request)
            request = http_request['miniamf.request']
