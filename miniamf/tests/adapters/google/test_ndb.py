...
if google.has_appengine_sdk():
    ...
    adapter = miniamf.get_adapter('google.appengine.ext.ndb')
...
class EncodeModelTestCase(google.BaseTestCase):
    ...
    def test_simple_named_alias(self):
        ...
        """
        miniamf.register_class(models.SimpleEntity, 'foo.bar')
...
class EncodeTestCase(google.BaseTestCase):
    ...
    def test_key_with_entity(self):
        ...
        self.assertEncodes(key, (
            b'\n\x0b\x01', (
                b'\t_key\x06eagx0ZXN0YmVkLXRlc3RyFQsSDFNpbXBsZUVudGl0eSIDYmFyDA',
            ),
            b'\x01'
        ), encoding=miniamf.AMF3)
...
class DecodeModelTestCase(google.BaseTestCase):
    ...
    def setUp(self):
        ...
        miniamf.register_class(models.SuperModel, 'pyamf.SM')
    ...
    def test_amf0(self):
        ...
        decoder = miniamf.decode(data, encoding=miniamf.AMF0)
    ...
    def test_amf3(self):
        ...
        decoder = miniamf.decode(data, encoding=miniamf.AMF3)
...
class KeyPropertyTestCase(google.BaseTestCase):
    ...
    def test_not_set(self):
        """
        .model is None - miniamf must handle the encode and decode cases
        """
        miniamf.register_class(models.Pet, 'pet')
    ...
    def test_but_missing(self):
        """
        .model is set to a key but the entity does not exist - miniamf must
        handle the encode and decode cases.
        """
        miniamf.register_class(models.Pet, 'pet')
        miniamf.register_class(models.SuperModel, 'supermodel')
...
class ExpandoTestCase(google.BaseTestCase):
    ...
    def test_expando(self):
        miniamf.register_class(models.SuperHero, 'SH')
...
class PolymodelTestCase(google.BaseTestCase):
    ...
    def test_person(self):
        miniamf.register_class(models.Person, 'Person')
    ...
    def test_company(self):
        miniamf.register_class(models.Company, 'Company')
...
class StructuredTestCase(google.BaseTestCase):
    ...
    def test_structured(self):
        miniamf.register_class(models.SPContact, 'SPContact')
        miniamf.register_class(models.SPAddress, 'SPAddress')
...
class LocalStructuredPropertyTestCase(google.BaseTestCase):
    ...
    def test_localstructured(self):
        miniamf.register_class(models.LSPContact, 'LSPContact')
        miniamf.register_class(models.SPAddress, 'SPAddress')
